...
一个交互式的全球 AI 算力基础设施可视化平台，以仓库内版本化静态数据快照呈现从稀土矿产到数据中心的完整半导体供应链。本站不是实时数据流。
...
- 🗺 交互式世界地图，标注全球算力设施位置
- 📊 静态数据仪表盘（KPI、趋势图、市场份额）
- 🏭 半导体代工厂对比矩阵（制程节点、产能、营收）
- ⚡ 供应链追踪（稀土、光刻、设计、能源）
- 📈 数据中心能耗与增长预测
- 🔍 全文搜索与多维筛选（国家、类型、层级）
- 📥 支持 CSV / JSON 数据导出
- 🌍 8 种语言界面：中文、English、日本語、한국어、العربية、Français、Deutsch、Español

## 🔌 API 状态

开发者页面展示的是未来可能提供的 REST 接口规划草案，并非已上线服务。当前版本不提供 API 域名、认证、限流、SDK 或服务等级承诺；请使用在线网站或仓库中的版本化静态数据。
...
本项目为纯前端应用，当前通过 GitHub Pages 免费发布：

https://freshtemp-labs.github.io/ai-compute-map/
...
本项目采用 **CC BY-SA 4.0**（Creative Commons Attribution-ShareAlike 4.0 International）许可。共享或改编内容时须注明来源，并以相同许可发布衍生内容。
